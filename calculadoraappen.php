...
<script>
	...
	var moneda=document.getElementsByName('moneda')[0].checked;
		...
		if (moneda==true){
			...
			$("#tiempo1").text(nuevotiempored1+' Hours');
			$("#tiempo2").text(nuevotiempored2+' Hours');
			$("#tiempo3").text(nuevotiempored3+' Hours');
...
<div class="cajaminidoble">
	...
	<div class="calculadora">
		...
		<div class="cajaazul">
	<div class="txtazul">Please complete your machine and your project data.</div>
			...
			<div class="txtcalcu"># Frames in your project:</div>
			...
			<div class="txtcalcu">Minutes required for a single frame to render (average)</div>
