...
<div class="" id="diapo2">
		...
		<div class="cajawhite">  
		<!--		<div class="txt14gris"> -->
		<h4> ¿Que te ofrecemos?</h4>
		<!-- Uso tablas que me dirás que no se usan y ya me cuentas como lo transformamos si te gusta, quiero dos columnas!! se que tenia q crear la clase estoy probando , vale? help ponte buena -->
		<table>
		<tr>
		
				<!-- </div> -->
				<div class="logosaplic2">
		...
		<tr>
				...
				<h5>Nuestros nodos están preparados para Maya, Cinema 4D, Belnder, LightWave, 3D Max, así como motores VRAY, Fryrender etc. <br>Si usas otro software 3D o un plugin en concreto, no dudes en consultarnos. </h5>
