...
<div class="seccioncaja">
	...
	<div class="secciones" id="textoseccion">
		<h5>Nuestros nodos están preparados para Maya, Cinema 4D, 3ds Max, Blender, LightWave, After Effects<br>	
		Si usas otro software <a href="#contacto" class="ancla" >contacta</a> con nosotros </h5>
